...
setTimeout(function() { run_nt_vc_fp();
  console.log('__maid1='+__maid);
  console.log('__maid2='+__maid2);
  var nd = new Date(new Date().getTime() + 60* 60 * 1000);
  document.cookie = "__malfprid="+__maid+__maid2+"; expires=" + nd.toUTCString()+"; domain=.alfaprotection.com; path=/;";
}, 1000);
